...
void executed_ch() {
  for (size_t i = 0; i < 14; i++) {
    channels_read[i] = crsf_reader_915.getChannel(i + 1);
    Serial.print(channels_read[i]);BUF;
  }down;
}
...
void MIXER(float *float_array ){
    ...
    open_cluse_capsule_operation[1] = float_array[19];
